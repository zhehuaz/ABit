...
/**
 * API for interaction with {@link com.balysv.materialmenu.MaterialMenuDrawable}
 */
public interface MaterialMenu {
    ...
    /**
     * @return {@link com.balysv.materialmenu.MaterialMenuDrawable} to be used for the menu
     */
